    ...
    return(
      <View style = {styles.container}>
        ...
        >
          ...
          <TouchableOpacity style={styles.routeCard} onPress={() => this.props.navigation.navigate("SpaceCraftScreen")}>
            <Text style={styles.routeText}>Spacecrafts</Text>
            <Image source={require("../assets/space_crafts.png")} style={styles.routeImg}></Image>
          </TouchableOpacity>

          <TouchableOpacity style={styles.routeCard} onPress={() => this.props.navigation.navigate("StarMapScreen")}>
            <Text style={styles.routeText}>Star Map</Text>
            <Image source={require("../assets/star_map.png")} style={styles.routeImg}></Image>
          </TouchableOpacity>

          <TouchableOpacity style={styles.routeCard} onPress={() => this.props.navigation.navigate("DailyPicScreen")}>
